...
class ObjectDetectionAPI(LabelStudioMLBase):
    ...
    def __init__(self, freeze_extractor=False, **kwargs):
        ...
        self.model = lp.Detectron2LayoutModel(
            config_path = 'https://www.dropbox.com/s/raubm858djy3u17/config.yaml?dl=1',
            ...
            label_map={0: "headline", 1: "article", 2: "newspaper_header", 3: "masthead", 
                4: "author", 5: "photograph", 6: "image_caption", 7: "page_number", 8: "table", 
                9: "cartoon_or_advertisement"}
        )
